...
\author{Chloe Summers, Arianna Elkins, \\ Cason Konzer, Heather Dawson  \\ \vspace{2.5mm}
       ...
       \includegraphics[scale = 0.9]{F:/Research/Funded/UIREEJ/Flint_River_Ecology/Slides/Img/-University_of_Michigan_Flint.png}
}
...
\begin{frame}
    ...
    \begin{minipage}{0.63\textwidth}
        \begin{center}
          \includegraphics[width=1.1\textwidth]{F:/Research/Funded/UIREEJ/Flint_River_Ecology/Slides/Img/-USA.png}
        \end{center}
    \end{minipage} % \pause
      \begin{minipage}{0.34\textwidth}
        \begin{center}
          \includegraphics[width=0.86\textwidth]{F:/Research/Funded/UIREEJ/Flint_River_Ecology/Slides/Img/-mit.png}
        \end{center}
    \end{minipage} % \pause
    \vspace{5mm}
    \begin{itemize}
...
\begin{frame}
    ...
    \centering
    \includegraphics[width=\textwidth]{F:/Research/Funded/UIREEJ/Flint_River_Ecology/Slides/Img/-Site_Map.png} \\
\end{frame}
...
\begin{frame}
    ...
    \begin{minipage}{0.44\textwidth}
        \begin{center}
          \includegraphics[width=0.7\textwidth]{F:/Research/Funded/UIREEJ/Flint_River_Ecology/Slides/Img/-1-1.png}
        \end{center}
    \end{minipage} % \pause
      \begin{minipage}{0.55\textwidth}
        \begin{center}
          \includegraphics[width=0.93\textwidth]{F:/Research/Funded/UIREEJ/Flint_River_Ecology/Slides/Img/-1-2.png}
        \end{center}
    \end{minipage} % \pause
    \begin{minipage}{0.44\textwidth}
        \begin{center}
          \includegraphics[width=0.7\textwidth]{F:/Research/Funded/UIREEJ/Flint_River_Ecology/Slides/Img/-1-3.png}
        \end{center}
    \end{minipage} % \pause
      \begin{minipage}{0.55\textwidth}
        \begin{center}
          \includegraphics[width=0.93\textwidth]{F:/Research/Funded/UIREEJ/Flint_River_Ecology/Slides/Img/-1-4.png}
        \end{center}
    \end{minipage} 
    % \begin{itemize}
...
\begin{frame}
    ...
    \begin{center} 
        \includegraphics[width=1.0\textwidth]{F:/Research/Funded/UIREEJ/Flint_River_Ecology/Slides/Img/-Diversity_Bubble_Plot_T.png} \\
    \end{center}
...
\begin{frame}
    ...
    \begin{center}
        \includegraphics[width=0.99\textwidth]{F:/Research/Funded/UIREEJ/Flint_River_Ecology/Slides/Img/-Hg.png} \\
    \end{center}
