...
\headerbox{Toxins}{name=box20, column=2, row=0}{
  \begin{center}
    \includegraphics[width=.99\textwidth]{Img/Hg.png} \\
  \end{center}
...
%%% Analysis %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{Analysis}{name=box21, column=2, row=1, below=box20}{
...
%%% The Mitten %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{Where is Flint?}{name=box30, column=3, row=0}{

  \hspace{5mm}

  \begin{center}
    \includegraphics[width=1.0\textwidth]{Img/mitt.jpg} \\
  \end{center}
