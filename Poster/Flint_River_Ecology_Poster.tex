...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
{
  ...
  \hspace{1mm} {\color{umblue}$\downharpoonright$} website : \textit{\color{violet}{https://flintriverecostudy.com}}
  \hspace{1mm} {\color{umblue}$\downharpoonright$} repository : \textit{\color{violet}{https://github.com/casonk/Flint\_River\_Ecology}}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Logo %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\headerbox{Diversity}{name=box10, column=1, row=0}{
  \begin{center}
    \includegraphics[width=\textwidth]{Img/Diversity_Bubble_Plot.png} \\
  \end{center}
...
\headerbox{Toxins}{name=box20, column=2, row=0}{
  \begin{center}
    \includegraphics[width=\textwidth]{Img/Hg.png} \\
  \end{center}
...
% %%% Conclusion %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \headerbox{Conclusion}{name=box31, column=3, row=1, below=box30}{
...
% %%% The Mitten %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \headerbox{Where is Flint?}{name=box32, column=3, row=2, below=box31}{
...
% %%% Acknowledgements %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \headerbox{Acknowledgements}{name=box33, column=3, row=3, below=box32, above=bottom}{
...
\headerbox{Where is Flint?}{name=box31, column=3, row=1, below=box30}{
  ...
  \begin{minipage}{0.5\textwidth}
    Flint is an hour and 45 minutes East of Grand Rapids. 
    Flint is the home to 81,252 unique residents, compared to Grand Rapids population size of 198,917.

  \end{minipage}
  \begin{minipage}{0.5\textwidth}
    \begin{center}
      \includegraphics[width=0.66\textwidth]{Img/mit.png}
    \end{center}
  \end{minipage}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
